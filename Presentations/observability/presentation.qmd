---
title: Observabilité
subtitle: Mise en place d'un système d'observation sans effort (ou presque)
...
author:
  - name: Thomas Cicognani
    email: zhykos.github.yy9x5@passmail.net
    affiliations: In my free time # company / event name for the true presentation
  - name: Grant McDermott
    email: gmcd@amazon.com
    affiliations: Créateur du template de présentation
date: 2025-01-01 # today for the true presentation
...
- définitions
  - logs
    - Conférence devfest nantes
  - métrique
  - traces
- Cas d'erreur
  - ErrorCase 2 : serveur qui tombe
  - ErrorCase : erreur 500
- Ajout de logs à la main
- Ajout de traces à la main
- Ajout de métriques à la main
- OpenTelemetry à la rescousse
  - système agnostique
  - collector
  - gratuité
  - open source
- Exemples
  - Deno
  - Java (avec et sans opentelemetry)
    - Agent
    - automatic
  - Javascript
  - SHOP
