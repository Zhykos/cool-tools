...
<template>
    <p v-if="props.products.length === 0" data-testid="product-list-title">No product</p>
    <p v-else data-testid="product-list-title">Select a product to put it on your basket</p>
    <ul>
